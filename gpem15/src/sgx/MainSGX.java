...
import sgx.Population;
import common.MyRandom;

public class MainSGX extends  MyRandom {
	public MainSGX() {}
...
//	String outDir = "/home/pta/projects/GP/src/SGXM/out/";
	String outDir = "./src/sgx/out/";
	...
	public void MStart(){
		...
		while (Seed<StartSeed+nrun)
		{
			...
			double fittest=myPop.ComputeFT(myPop.bestcurrent[pos]);
	...
	public static void main(String[] args)throws IOException{
		MainSGX a = new MainSGX();	
		
	
		
		System.out.printf("SGX: " + PROBLEM + "\n");
		a.MStart();
