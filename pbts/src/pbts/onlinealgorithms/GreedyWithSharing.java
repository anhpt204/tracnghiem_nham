...
public class GreedyWithSharing implements OnlinePlanner {
	...
	public ItineraryServiceSequence computeBestProfitsItineraryPeopleInsertion(Vehicle taxi, int nextStartTimePoint, 
		...
		ItineraryTravelTime I = sim.establishItinerary(nextStartTimePoint,fromIndex,
			reqID,fromPoint,ss);
		if(I == null) return null;
		return new ItineraryServiceSequence(taxi, I, ss);
	}
	public ItineraryServiceSequence computeBestProfitsItineraryParcelInsertion(Vehicle taxi, int nextStartTimePoint, 
	...
	public void processParcelRequestOld(ParcelRequest pr) {
		// TODO Auto-generated method stub
