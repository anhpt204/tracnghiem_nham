...
public class RiskCostFromFloodingData implements TravelCost, LinkEnterEventHandler {
...
//		double time;
	...
	public void handleEvent(LinkEnterEvent event) {
		...
		AgentMoneyEventImpl e = new AgentMoneyEventImpl(event.getTime(), event
...
//		new RiskCostFromFloodingData(net, fr,events);
//	}
