...
public class RiskCostFromNetworkChangeEventsTest extends MatsimTestCase {
	...
	public void testRiskCostCalculatorNoCostsForEqualRiskLinks() {
		...
		RiskCostFromNetworkChangeEvents rcc = new RiskCostFromNetworkChangeEvents(net,false, EventsUtils.createEventsManager());
		assertEquals("Risk cost:" , 0. , rcc.getLinkTravelDisutility(l0,Time.UNDEFINED_TIME, null, null));
		assertEquals("Risk cost:" , 107400. * 10., rcc.getLinkTravelDisutility(l1,Time.UNDEFINED_TIME, null, null));
		assertEquals("Risk cost:" , 0. , rcc.getLinkTravelDisutility(l2,Time.UNDEFINED_TIME, null, null));
		assertEquals("Risk cost:" , 0. , rcc.getLinkTravelDisutility(l3,Time.UNDEFINED_TIME, null, null));
		assertEquals("Risk cost:" , 106800. * 2.5, rcc.getLinkTravelDisutility(l4,Time.UNDEFINED_TIME, null, null));
	...
	public void testRiskCostCalculatorChargeEqualRiskLinks() {
		...
		RiskCostFromNetworkChangeEvents rcc = new RiskCostFromNetworkChangeEvents(net,true, EventsUtils.createEventsManager());

		assertEquals("Risk cost:" , 106800. * 2.5, rcc.getLinkTravelDisutility(l0,Time.UNDEFINED_TIME, null, null), 1e-8);
		assertEquals("Risk cost:" , 107400. * 3.5, rcc.getLinkTravelDisutility(l1,Time.UNDEFINED_TIME, null, null), 1e-8);
		assertEquals("Risk cost:" , 107400. * 4.5, rcc.getLinkTravelDisutility(l2,Time.UNDEFINED_TIME, null, null), 1e-8);
		assertEquals("Risk cost:" , 0. , rcc.getLinkTravelDisutility(l3,Time.UNDEFINED_TIME, null, null), 1e-8);
		assertEquals("Risk cost:" , 0. , rcc.getLinkTravelDisutility(l4,Time.UNDEFINED_TIME, null, null), 1e-8);
		assertEquals("Risk cost:" , 106800. * 5.5, rcc.getLinkTravelDisutility(l5,Time.UNDEFINED_TIME, null, null), 1e-8);
