...
public class RiskCostFromFloodingDataTest extends MatsimTestCase {
	...
	public void testRiskCostFromFloodingData() {
		...
		double l0Cost = rcf.getLinkTravelDisutility(l0, Time.UNDEFINED_TIME, null, null);
		...
		double l0InverseCost = rcf.getLinkTravelDisutility(l0Inverse, Time.UNDEFINED_TIME, null, null);
		...
		double l1Cost = rcf.getLinkTravelDisutility(l1, Time.UNDEFINED_TIME, null, null);
		...
		double l1InverseCost = rcf.getLinkTravelDisutility(l1Inverse, Time.UNDEFINED_TIME, null, null);
		...
		double l2Cost = rcf.getLinkTravelDisutility(l2, Time.UNDEFINED_TIME, null, null);
		...
		double l2InverseCost = rcf.getLinkTravelDisutility(l2Inverse, Time.UNDEFINED_TIME, null, null);
		...
		events.processEvent(new LinkEnterEvent(0., id, l0.getId(), null));
		refCost += 28044.9329790229 / -600.;
		events.processEvent(new LinkEnterEvent(0., id, l0Inverse.getId(), null));
		refCost += 0.;
		events.processEvent(new LinkEnterEvent(0., id, l1.getId(), null));
		refCost += 124.44247096468449 / -600.;
		events.processEvent(new LinkEnterEvent(0., id, l1Inverse.getId(), null));
		refCost += 0.;
		events.processEvent(new LinkEnterEvent(0., id, l2.getId(), null));
		refCost += 497.60526643476226 / -600.;
		events.processEvent(new LinkEnterEvent(0., id, l2Inverse.getId(), null));
		refCost += 0.;
