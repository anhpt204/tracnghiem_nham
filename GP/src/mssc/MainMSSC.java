...
import mssc.Population;
import common.MyRandom;

public class MainMSSC extends  MyRandom {
	public MainMSSC() {}
...
//	String outDir = "/home/pta/projects/GP/src/MSSC/out/";
	String outDir = "./src/mssc/out/";
	public void MStart()
	{
	...
	{
		MainMSSC a = new MainMSSC();	
		
	
		
		System.out.printf("MainMSSC!");
		a.MStart();
