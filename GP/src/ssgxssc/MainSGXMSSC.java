...
import ssgxssc.Population;
import common.MyRandom;

public class MainSGXMSSC extends  MyRandom {
	public MainSGXMSSC() {}
...
//	String outDir = "/home/pta/projects/GP/src/SGXMSSC/out/";
	String outDir = "./src/ssgxssc/out/";
	...
	public static void main(String[] args)throws IOException{
		MainSGXMSSC a = new MainSGXMSSC();	
		
		System.out.printf("MainSGXMSSC: " + PROBLEM + "\n");
		a.MStart();
