...
import ssc.Population;
import common.MyRandom;

public class MainSSC extends  MyRandom {
	public MainSSC() {}
...
//	String outDir = "/home/pta/projects/GP/src/SSC/out/";
	String outDir = "./src/ssc/out/";
	...
	{
		MainSSC a = new MainSSC();	
		
	
		
		System.out.printf("MainSSC!");
		a.MStart();
