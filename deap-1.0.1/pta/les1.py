...
#             lines.append('\n')
            ...
            try:
                for i in xrange(len(left_equations[-1])):
                    left_equations[-1][i] = 1
                subTrainingOutputs[-1] = 1
                # solve Ax = b 
...
#                         break
                ...
                if need_eval:
                    ...
                    if best_individuals == None or fitness < best_fitness:
...
#                 return
    ...
    if coNo:
        ...
        return fitness, fittest, size, best_x        
            #break
    else:
        return -1, -1, -1,-1
...
if __name__ == "__main__":
    ...
    for problem in problems:
        ...
        out = open('out/' + problem + ".les1.out", 'wb')
        fitness_runs = []
        fittest_runs=[]
        size_runs = []
        time_runs =[]
        ...
        for job in xrange(JOBS):
            ...
            fitness, fittest, size, solution = les(problem, job=job)
            if(fitness == -1):
                continue
        ...
        if(len(fitness_runs) > 0):
            ...
            out.write(' '.join(str(xi) for xi in solution))
