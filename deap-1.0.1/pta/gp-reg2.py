...
# 
# #read training data
# lines = open('data/'+train).readlines()
# trainingInputs = []
# trainingOutputs = []
# 
# for line in lines[1:]:
...
#     
# # read testing data
# lines = open('data/' + test).readlines()
# testingInputs = []
# testingOutputs = []
# 
# for line in lines[1:]:
...
#     sqerrors = ((func(x) - x**4 - x**3 - x**2 - x)**2 for x in points)
    ...
    for i in xrange(len(trainingInputs)):
        t = func(trainingInputs[i][0], trainingInputs[i][1])
...
def describe(individual):
    ...
    for i in xrange(len(testingInputs)):
        t = func(testingInputs[i][0], testingInputs[i][1])
...
#     main()
    ...
    for problem in problems:
        ...
        treeFilter(problem, "safeDivKoKTNo", False)
