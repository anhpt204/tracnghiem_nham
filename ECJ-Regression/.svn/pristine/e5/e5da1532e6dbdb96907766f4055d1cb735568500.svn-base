...
public class ProbabilisticTourSelection extends SelectionMethod implements SteadyStateBSourceForm
    ...
    SFProblem problem;// = (SimpleProblemForm)(this.evaluator.p_problem.clone());
    ...
    public boolean betterThan(Individual first, Individual second, 
    	...
    	double subStd = Math.sqrt((f1.getVariance() + f2.getVariance())/problem.NUMBOOTSAMPLE);
