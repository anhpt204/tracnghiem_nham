...
import ec.gp.koza.GPKozaDefaults;
 ...
 /*
 * @author Pham Tuan Anh: GSGP (Moraglio) +SSC (Uy)
 * @version 1.0 
 */

public class SGXMSSCPipeline extends GPBreedingPipeline
    {
    ...
    public SGXMSSCPipeline() { parents = new GPIndividual[2]; }
    ...
    public Object clone()
        {
        SGXMSSCPipeline c = (SGXMSSCPipeline)(super.clone());
     	    	...
     	    	else//ssc
     	    	{
     	    		...
     	    		for(int x=0;x<numTries;x++)
     	    		{
     	            	...
     	            	for (int i = 0; i < 12; i++)
     	            	{
     	                    ...
     	                    double ft = getSimilarity(state, p1, p2, thread);
