...
public class SimpleEvolutionState extends EvolutionState
    ...
    public void startFresh() 
        ...
        //need for geometric, lgx
//        genTreelib(200);
        
        // for AGX, RDO
        genTreelibForAGX(1000, 4);
    ...
    public void genTreelibForAGX(int treelibsize, int depth)
    {
//    	maxTreelibSize = treelibsize;
        // randomly generate semantic treelib
        SimpleProblemForm problem = (SimpleProblemForm)(this.evaluator.p_problem.clone());
        ...
        kdtreelib = new KDTree<GPNode>(problem.getNumOfFitcases());
        ...
        {
        	ind.trees[0].buildTreeForTreelib(this, 0, depth);
        	       	
        	double[] semantic = problem.getSemantic(this, ind.trees[0].child, 0);
        	try
        	{
        		kdtreelib.insert(semantic, (GPNode)ind.trees[0].child.clone());
