...
public class GPTree implements GPNodeParent, Prototype
    ...
    public static final String P_SEMANTICLEN = "semanticlen";
    ...
    //PTA
    public double[] semanticTraining;
    public double[] semanticTesting;
    ...
    public Object clone()
        ...
        newtree.semanticTraining = semanticTraining.clone();
        newtree.semanticTesting = semanticTesting.clone();
        return newtree;
        }
    ...
    public void setup(final EvolutionState state, final Parameter base)
        ...
        //PTA - semantic
        SimpleProblemForm problem = (SimpleProblemForm)(state.evaluator.p_problem.clone());

        //int semanticlen = state.parameters.getInt(base.push(P_SEMANTICLEN), def.push(P_SEMANTICLEN),1);
        semanticTraining = new double[problem.getNumOfFitcases()];
        semanticTesting = new double[problem.getNumOfTestcases()];
    ...
    */
    ...
    public void buildTreeForTreelib(final EvolutionState state, final int thread, int depth) 
    {
    	GPInitializer initializer = ((GPInitializer)state.initializer);
    	child = constraints(initializer).init.newRootedTreeForTreelib(state,
    			constraints(initializer).treetype,
    			thread,
    			this,
    			constraints(initializer).functionset,
