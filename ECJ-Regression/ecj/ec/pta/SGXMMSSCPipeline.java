...
public class SGXMMSSCPipeline extends GPBreedingPipeline
    {
    ...
    public SGXMMSSCPipeline() { parents = new GPIndividual[2]; }
    ...
    public Object clone()
        {
        SGXMMSSCPipeline c = (SGXMMSSCPipeline)(super.clone());
