 ...
 *
 * @author PTA : SGGP (Moraglio + SC)
 * @version 1.0 
 */

public class SGXESCPipeline extends GPBreedingPipeline
    {
    ...
    public SGXESCPipeline() { parents = new GPIndividual[2]; }
    ...
    public Object clone()
        {
        SGXESCPipeline c = (SGXESCPipeline)(super.clone());
