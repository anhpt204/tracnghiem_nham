        ...
        for(int job = currentJob ; job < numJobs; job++)
            ...
            // try
                ...
                if (numJobs > 1)                                                    // only if iterating (so we can be backwards-compatible),
                    {
                    String jobFilePrefix = "/home/pta/projects/ECJ-Regression/out/" + alg + "/" + problem + "/job." + job + ".";
...
//				"bvgp"
    	...
    	for(String problem_name : problems)
    	{
    		...
    		for(String alg: algs)
    		{
    			String param_file = "/home/pta/projects/ECJ-Regression/params/" + alg + "/" + problem_name +".params";
